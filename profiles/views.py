    ...
    def get(self, request):
        ...
        if not pk:
            if id and id != "null":
                ...
                serializer = ChildProfileDisplaySerializer(children_profiles, many=True, context={'request': request})
            ...
            try:
                ...
                print(e)
            serializer = ChildProfileDisplaySerializer(child,context={'request': request})
            return Response({"data": serializer.data, "success": True}, status=status.HTTP_200_OK)
